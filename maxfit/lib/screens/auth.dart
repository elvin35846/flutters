  ...
  Widget build(BuildContext context) {
    ...
    Widget _logo(){
      return Padding(
        ...
        child: Container(
          child: Align(
            child: Text('MAXFIT', style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Colors.white),),
          ),
        )
      );
    }
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    child: Text('Not registered yet? Register!', style: TextStyle(fontSize: 12, color: Colors.white)),
                    onTap: (){
                      setState(() {
                        showLogin = false;
                      });
            ...
            Column(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.all(10),
                  child: GestureDetector(
                    child: Text('Already registered? Login!', style: TextStyle(fontSize: 12, color: Colors.white)),
                    onTap: (){
                      setState(() {
                        showLogin = true;
                      });
