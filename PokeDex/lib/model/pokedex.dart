...
//
//     final remoteApiModel = remoteApiModelFromJson(jsonString);

import 'dart:convert';

RemoteApiModel remoteApiModelFromJson(String str) => RemoteApiModel.fromJson(json.decode(str));

String remoteApiModelToJson(RemoteApiModel data) => json.encode(data.toJson());
...
class RemoteApiModel {
    ...
    factory RemoteApiModel.fromJson(Map<String, dynamic> json) => RemoteApiModel(
